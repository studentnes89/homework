...
plt.title('Correlogram of GDP', fontsize=60)
...
plt.title('Distribution of regions by GRP level from the smallest to the largest', fontsize=45)
st.pyplot(fig)
...
ax.scatter(x, y, z)
plt.title('Separation of Investments', fontsize=45)
st.pyplot(fig)
